    ...
    <section id="about" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          ...
          Focused on front-end web development. Proficient in JavaScript, React, and the MERN stack, with a strong foundation in backend technologies and databases. A dedicated continuous learner, adaptable to new technologies in the ever-evolving field of Software Developement.
          </p>
        </div>
        <div className="mt-10">
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
            {aboutItems.map((item) => (
              <div key={item.name} className="relative">
                <dt>
                  <div className="absolute flex items-center justify-center h-12 w-12 rounded-md bg-primary/85 text-primary-foreground">
